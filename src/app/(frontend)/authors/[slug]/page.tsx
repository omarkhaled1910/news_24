...
export default async function AuthorPage({ params: paramsPromise, searchParams }: Args) {
  ...
  const subscriberCount =
    author.subscriberCount && formatSubscriberCount(author.subscriberCount)
...
export async function generateMetadata({ params: paramsPromise }: Args): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      type: 'profile',
      images: author.photo && typeof author.photo === 'object' && author.photo.url
