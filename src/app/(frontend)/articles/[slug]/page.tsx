...
export async function generateStaticParams() {
  try {
    ...
    console.warn('Database unavailable during build, generating articles dynamically:', error)
    return []
  }
}
  ...
  return (
    <article className="min-h-screen pb-16" dir={dir}>
      ...
      <header className="container mt-8 mb-6">
        ...
        {/* AI Model badge */}
        {article.isAutoGenerated && article.aiModel && (
          <div className="mb-6">
            <AiModelBadge aiModel={article.aiModel} locale={locale as 'ar' | 'en'} />
          </div>
        )}
